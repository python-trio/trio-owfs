...
project = "Onewire for Trio"
copyright = "The Onewire for Trio authors"
author = "The Onewire for Trio authors"
...
latex_documents = [
    (master_doc, "asyncowfs.tex", "Trio Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "asyncowfs", "Onewire for Trio Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "asyncowfs",
        "Onewire for Trio Documentation",
        author,
        "Onewire for Trio",
        "Access to 1wire",
        "Miscellaneous",
